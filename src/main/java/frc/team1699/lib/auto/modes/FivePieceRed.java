...
// TODO fix
public class FivePieceRed extends AutoMode {
    private ArrayList<Event> events;
    private int i;

    public FivePieceRed(Manipulator manipulator, Drive swerve) {
        ...
        PathPlannerTrajectory trajectoryThree = PathPlannerPath.fromPathFile("ROPTP2").getTrajectory(new ChassisSpeeds(), new Rotation2d());
        PathPlannerTrajectory trajectoryFour = PathPlannerPath.fromPathFile("R5P4").getTrajectory(new ChassisSpeeds(), Rotation2d.fromDegrees(-33));
        PathPlannerTrajectory trajectoryFive = PathPlannerPath.fromPathFile("R5P5").getTrajectory(new ChassisSpeeds(), Rotation2d.fromDegrees(-5));
        ...
        arrayThree.add(new FollowTrajectoryEvent(trajectoryFive, swerve));
        ...
        arrayThree.add(new SequentialEvent(shootSequence));
        events.add(new DeadlineEvent(arrayThree));
